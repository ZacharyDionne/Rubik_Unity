...
public class RubiksCube : MonoBehaviour
{
	...
	*/
	...
	protected void RotateAnimation()
    {
		...
		degreeCounter += Math.Abs(currentRotation);
		...
		if (degreeCounter >= 90.0f)
        {
            ...
            {
				for (int i = 0; i < 9; i++)
					cubyPositions[RubikData.rotationPositions[index, i]].RotateAround(transform.position, currentAxis, 90.0f - degreeCounter * direction);
			}
